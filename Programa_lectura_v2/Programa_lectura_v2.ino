...
void loop(void) {
  ...
  Serial.print("Tension entrada:    ;"); Serial.print(busvoltage1); Serial.println("; V");
  ...
  Serial.print("Tension consumo:    ;"); Serial.print(busvoltage2); Serial.println("; V");
  Serial.print("Intensidad consumo: ;"); Serial.print(current_mA2); Serial.println("; mA");
  Serial.print("Potencia consumo:   ;"); Serial.print(potencia2); Serial.println("; W");
  Serial.println("");
  ...
  Serial.print("Tensión bateria:    "); Serial.print(busvoltage3); Serial.println(" V");
  Serial.print("Intensidad bateria: "); Serial.print(current_mA3); Serial.println(" mA");
  Serial.print("Potencia bateria:   "); Serial.print(potencia3); Serial.println(" W");
  Serial.println("");
